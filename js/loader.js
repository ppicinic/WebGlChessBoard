...
var whiteName = "Player 1";
var blackName = "Player 2";
...
wTeamName.style.fontSize = "17px";
wTeamName.style.fontWeight = 'bolder';
wTeamName.bold = true;
wTeamName.innerHTML = "";
...
bTeamName.style.fontSize = "17px";
bTeamName.style.fontWeight = 'bolder';
bTeamName.bold = true;
bTeamName.innerHTML = "";
